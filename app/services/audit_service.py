...
ACTION_LABELS = {
    ...
    "category.created": "Création d'une catégorie",
    "user.anonymized": "Anonymisation d'un utilisateur",
    ...
    "equipment.created": "Création d'un équipement",
    "equipment.updated": "Modification d'un équipement",
    "equipment.status_changed": "Changement de statut d'un équipement",
    "equipment.archived": "Réforme d'un équipement",
    "maintenance_plan.created": "Création d'un plan de métrologie",
    "maintenance_plan.updated": "Modification d'un plan de métrologie",
    "maintenance_plan.rescheduled": "Recalcul d'une échéance",
    "maintenance_event.created": "Réalisation métrologique enregistrée",
    "ciq.parameter.created": "Création d'un paramètre CIQ",
    "ciq.parameter.updated": "Modification d'un paramètre CIQ",
    "ciq.config.updated": "Modification des règles CIQ",
    "ciq.level.created": "Création d'un niveau de contrôle",
    "ciq.level.updated": "Modification d'un niveau de contrôle",
    "ciq.lot.created": "Création d'un lot de contrôle",
    "ciq.lot.updated": "Modification d'un lot de contrôle",
    "ciq.limits.created": "Nouveau jeu de limites",
    "ciq.limits.closed": "Clôture d'un jeu de limites",
    "ciq.run.created": "Saisie d'une série CIQ",
    "ciq.result.created": "Ressaisie d'un résultat CIQ",
    "ciq.result.voided": "Annulation d'un résultat CIQ",
    "ciq.run.justified": "Traitement d'un rejet CIQ",
    "corrective_action.created": "Création d'une action corrective",
    "corrective_action.completed": "Action corrective réalisée",
    "corrective_action.validated": "Validation d'une action corrective",
    "corrective_action.reopened": "Réouverture d'une action corrective",
    "transmission.created": "Nouvelle transmission",
    "transmission.read": "Lecture d'une transmission",
    "transmission.status_changed": "Changement de statut d'une transmission",
    "transmission.commented": "Commentaire sur une transmission",
    "nc.created": "Création d'une non-conformité",
    "nc.updated": "Modification d'une non-conformité",
    "nc.status_changed": "Changement de statut d'une non-conformité",
    "billing.customer_created": "Création du client Stripe",
    "billing.checkout_started": "Souscription démarrée",
}
...
def action_label(action: str) -> str:
    ...
    if action.startswith("billing."):
        return "Abonnement : événement Stripe " + action.removeprefix("billing.")
    return action
